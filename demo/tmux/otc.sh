...
# Fifth panel (top-right) - Start trader
tmux send-keys -t $SESSION_NAME:0.4 "sleep 10; yarn trader" C-m

# Sixth panel (bottom-right) - Guardian
tmux send-keys -t $SESSION_NAME:0.5 "sleep 7; node apps/PSYMM-OTC/guardian.js 127.0.0.4 3" C-m
