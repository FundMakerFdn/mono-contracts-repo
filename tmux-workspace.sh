...
# Right pane (top)
tmux send-keys -t $SESSION_NAME:0.3 "sleep 10; yarn addSymm 0; sleep 2; yarn pSymmA" C-m
tmux send-keys -t $SESSION_NAME:0.4 "sleep 10; yarn addSymm 1; sleep 2; yarn pSymmB" C-m
