...
async function deployFixture() {
  ...
  // Deploy ETFMaker factory
  const etfMakerFactory = await hre.viem.deployContract("ETFMaker");
  ...
  // We don't mint to partyB here, as the test will mint tokens as needed
  ...
  // Generate custody IDs (uncommented for clarity)
...
async function main() {
  ...
  const outputData = {
    ...
    custodyId_A: contracts.custodyId_A,
    custodyId_B: contracts.custodyId_B,
  };
